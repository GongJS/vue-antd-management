<template>
  <div>
    ...
    <a-card title="Mock-单选-删除 " style="margin:10px 0">
...
<script>
import {Card, Table, Modal, Button, message} from 'ant-design-vue'
...
export default {
  ...
  methods: {
    ...
    request () {
      ...
      axios.ajax({
        ...
        if (res.code === 0) {
          ...
          this.pagination = Utils.pagination(res, (current) => {
    ...
    handleDelete () {
      console.log(33, this.selectedRows)
